...
// export function structureLayingTransform(structure: Structure, referenceRotation?: Mat3): { rotation: Mat3, origin: Vec3 } {
//     const coords = selectMainCoords(structure, MIN_ATOMS_FOR_PCA);
...
// TODO remove this module (code moved to Mol*)